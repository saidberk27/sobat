...
while True:
    ...
    lower_whitesmoke = np.array([0,0,200])
    upper_whitesmoke = np.array([180,25,255])
    ...
    mask1 = cv2.inRange(hsv,lower_whitesmoke,upper_whitesmoke)
    ...
    for c in cnts1:
        ...
        if area1 > 5000:
            ...
            cv2.putText(frame,"Whitesmoke",(cx-20,cy-20),cv2.FONT_HERSHEY_SIMPLEX,2.5,(255,255,255),3)
