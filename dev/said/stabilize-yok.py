...
class MotorControl:
    ...
    def stop_motors(self):
        ...
        for i in range(1, 7):  # 6 motor için
            self.master.mav.command_long_send(
                self.master.target_system,
                self.master.target_component,
                mavutil.mavlink.MAV_CMD_DO_SET_SERVO,
                0,
                i,  # Servo (motor) numarası
                3000,  # PWM değeri
                0, 0, 0, 0, 0)
        
        print("All motors stopped with 3000 speed")
    ...
    def get_user_input(self):
        ...
        while True:
            ...
            print("5 - Yukarı")
            print("6 - Aşağı")
            print("7 - Saat Yönünde Dönüş")
            print("8 - Saat Yönünün Tersine Dönüş")
            ...
            for movement in self.movements:
                if movement[0] == "wait":
                    ...
                    if movement[0] == '1':  # İleri
                        ...
                        z = -self.motor_speed
                    elif movement[0] == '7':  # Saat Yönünde Dönüş
                        r = self.motor_speed
                    elif movement[0] == '8':  # Saat Yönünün Tersine Dönüş
                        r = -self.motor_speed
    ...
    def run(self):
        self.get_heartbeat()
        self.arm_vehicle()
        print("Vehicle is ready for manual control")
        self.get_user_input()
