...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<multiplier-request> is deprecated: use test-srv:multiplier-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<multiplier-response> is deprecated: use test-srv:multiplier-response instead.")))
