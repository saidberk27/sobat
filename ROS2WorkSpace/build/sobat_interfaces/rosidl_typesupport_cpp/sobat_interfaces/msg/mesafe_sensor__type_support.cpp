...
static const _MesafeSensor_type_support_symbol_names_t _MesafeSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sobat_interfaces, msg, MesafeSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sobat_interfaces, msg, MesafeSensor)),
  }
};
...
{
  return &::sobat_interfaces::msg::rosidl_typesupport_cpp::MesafeSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sobat_interfaces, msg, MesafeSensor)() {
  return get_message_type_support_handle<sobat_interfaces::msg::MesafeSensor>();
}
